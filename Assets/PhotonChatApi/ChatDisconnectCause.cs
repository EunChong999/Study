...
namespace Photon.Chat
{
    ...
    public enum ChatDisconnectCause
    {
        ...
        ExceptionOnConnect,
        /// <summary>OnStatusChanged: The server disconnected this chatClient. Most likely the server's send buffer is full (receiving too much from other clients).</summary>
        DisconnectByServer,
        /// <summary>OnStatusChanged: This chatClient detected that the server's responses are not received in due time. Maybe you send / receive too much?</summary>
        TimeoutDisconnect,
        ...
        InvalidRegion,
        /// <summary>OnOperationResponse: Operation that's (currently) not available for this chatClient (not authorized usually). Only tracked for op Authenticate.</summary>
        OperationNotAllowedInCurrentState,
        /// <summary>OnOperationResponse: Authenticate in the Photon Cloud with invalid chatClient values or custom authentication setup in Cloud Dashboard.</summary>
