...
namespace Photon.Chat
{
    ...
    /// messages between this chatClient and the servers. A short workflow will connect you to a chat server.
    ///
    ...
    public class ChatClient : IPhotonPeerListener
    {
        ...
        /// <summary>
        /// Checks if this chatClient is ready to send messages.
        /// </summary>
        public bool CanChat
        {
        ...
        /// <summary>
        /// Checks if this chatClient is ready to publish messages inside a public channel.
        /// </summary>
        /// <param name="channelName">The channel to do the check with.</param>
        /// <returns>Whether or not this chatClient is ready to publish messages inside the public channel with the specified channelName.</returns>
        ...
        /// <summary>The version of your chatClient. A new version also creates a new "virtual app" to separate players from older chatClient versions.</summary>
        ...
        /// <summary> Public channels this chatClient is subscribed to. </summary>
        public readonly Dictionary<string, ChatChannel> PublicChannels;
        /// <summary> Private channels in which this chatClient has exchanged messages. </summary>
        ...
        /// <summary> The Chat Peer used by this chatClient. </summary>
        ...
        /// <summary>
        /// Chat chatClient constructor.
        /// </summary>
        /// <param name="listener">The chat listener implementation.</param>
        /// <param name="protocol">Connection protocol to be used by this chatClient. Default is <see cref="ConnectionProtocol.Udp"/>.</param>
        ...
        /// <summary>
        /// Connects this chatClient to the Photon Chat Cloud service, which will also authenticate the user (and set a UserId).
        /// </summary>
        ...
        /// <summary>
        /// Must be called regularly to keep connection between chatClient and server alive and to process incoming messages.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <returns>True as long as the chatClient is not disconnected.</returns>
        ...
        public bool Subscribe(string[] channels, int[] lastMsgIds)
        {
            ...
            Dictionary<byte, object> opParameters = new Dictionary<byte, object>
            {
                ...
                { ChatParameterCode.HistoryLength, -1 } // server will decide how many messages to send to chatClient
            };
        ...
        /// <summary>
        /// Sends operation to subscribe chatClient to channels, optionally fetching a number of messages from the cache.
        /// </summary>
        /// <remarks>
        ...
        /// <remarks>
        /// The chatClient will remove these channels from the PublicChannels dictionary once the server sent a response to this request.
        ///
        ...
        /// <summary>Sends a message to a public channel which this chatClient subscribed to.</summary>
        /// <remarks>
        ...
        /// <returns>False if the chatClient is not yet ready to send messages.</returns>
        ...
        /// <summary>
        /// Sends a private message to a single target user. Calls OnPrivateMessage on the receiving chatClient.
        /// </summary>
        ...
        /// to their current online status (and whatever info your chatClient sets in it).
        ///
        ...
        /// with AddFriends).
        ///
        /// Photon flushes friends-list when a chat chatClient disconnects, so it has to be
        ...
        /// </summary>
        /// <remarks>
        /// Photon flushes friends-list when a chat chatClient disconnects. Unless you want to
        ...
        /// <summary>
        /// Get you the (locally used) channel name for the chat between this chatClient and another user.
        /// </summary>
        ...
        void IPhotonPeerListener.OnStatusChanged(StatusCode statusCode)
        {
            switch (statusCode)
            {
                ...
                case StatusCode.EncryptionEstablished:
                    // once encryption is available, the chatClient should send one (secure) authenticate. it includes the AppId (which identifies your app on the Photon Cloud)
                    if (!this.didAuthenticate)
                    {
                        this.didAuthenticate = this.chatPeer.AuthenticateOnNameServer(this.AppId, this.AppVersion, this.chatRegion, this.AuthValues);
                        if (!this.didAuthenticate)
