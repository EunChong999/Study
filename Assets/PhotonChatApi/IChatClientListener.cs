...
namespace Photon.Chat
{
    ...
    /// <summary>
    /// Callback interface for Chat chatClient side. Contains callback methods to notify your app about updates.
    ...
    public interface IChatClientListener
    {
        ...
        /// <summary>
        /// Notifies app that chatClient got new messages from server
        ...
        /// <summary>
        /// Notifies chatClient about private message
        /// </summary>
