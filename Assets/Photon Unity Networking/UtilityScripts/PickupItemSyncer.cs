...
public class PickupItemSyncer : Photon.MonoBehaviour
{
    ...
    public void OnJoinedRoom()
    {
        ...
        // this chatClient joined the room. let's see if there are players and if someone has to inform us about pickups
    ...
    public void AskForPickupItemSpawnTimes()
    {
        if (this.IsWaitingForPickupInit)
        {
            ...
            if (nextPlayer == null || nextPlayer.Equals(PhotonNetwork.player))
            {
                ...
                //Debug.Log("This player is the Master's next. Asking this chatClient's 'next' player: " + ((nextPlayer != null) ? nextPlayer.ToStringFull() : ""));
            }
