...
namespace ExitGames.Demos.DemoAnimator
{
	public class Launcher : Photon.PunBehaviour {
		...
		/// <summary>
		/// This chatClient's version number. Users are separated from each other by gameversion (which allows you to make breaking changes).
		/// </summary>
		...
		void Awake()
		{
			...
			// #Critical
			// this makes sure we can use PhotonNetwork.LoadLevel() on the master chatClient and all clients in the same room sync their level automatically
		...
		public override void OnConnectedToMaster()
		{
			...
			if (isConnecting)
			{
				...
				Debug.Log("DemoAnimator/Launcher: OnConnectedToMaster() was called by PUN. Now this chatClient is connected and could join a room.\n Calling: PhotonNetwork.JoinRandomRoom(); Operation will fail if no room found");
