...
public class GUIFriendFinding : MonoBehaviour
{
    ...
    void Start()
    {
        // If a user should be "findable", the chatClient must set a playerName before connecting.
        // This is then used during connect and the chatClient can be found by others.
