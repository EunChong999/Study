...
public interface IPunObservable
{
    ...
    /// PhotonNetwork.sendRate affects how often packages are sent by this chatClient.<br/>
    ///
...
internal class PunEvent
{
    ...
    public const byte AssignMaster = 208;  // TS: added to assign someone master chatClient (overriding the current)
...
/// </summary>
/// <remarks>
/// The isWriting property will be true if this chatClient is the "owner" of the PhotonView (and thus the GameObject).
...
public class PhotonStream
{
    ...
    /// <summary>If true, this chatClient should add data to the stream to send it.</summary>
    public bool isWriting
    {
        get { return this.write; }
    }

    /// <summary>If true, this chatClient should read data send by another chatClient.</summary>
