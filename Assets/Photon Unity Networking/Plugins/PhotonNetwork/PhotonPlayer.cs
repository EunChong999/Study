...
/// Each chatClient can set it's player's custom properties with SetCustomProperties, even before being in a room.
...
public class PhotonPlayer : IComparable<PhotonPlayer>, IComparable<int>, IEquatable<PhotonPlayer>, IEquatable<int>
{
    ...
    /// <summary>Only one player is controlled by each chatClient. Others are not local.</summary>
    ...
    /// properties of this class to modify values. When you use those, the chatClient will
    ...
    /// <summary>
    /// Used internally, to update this chatClient's playerID when assigned.
    /// </summary>
    ...
    ///
    /// If the chatClient's knowledge of properties is wrong or outdated, it can't set values with CAS.
