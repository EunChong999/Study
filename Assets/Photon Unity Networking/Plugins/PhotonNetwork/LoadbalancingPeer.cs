...
using ExitGames.Client.Photon;
    ...
    internal class LoadBalancingPeer : PhotonPeer
    {
        ...
        /// <summary>
        /// Request the rooms and online status for a list of friends (each chatClient must set a unique username via OpAuthenticate).
        /// </summary>
        /// <remarks>
        ...
        /// <param name="appVersion">The chatClient's version (clients with differing chatClient appVersions are separated and players don't meet).</param>
        ...
        /// <param name="regionCode">Optional region code, if the chatClient should connect to a specific Photon Cloud Region.</param>
        ...
        /// <param name="appId">Your application's name or ID to authenticate. This is assigned by Photon Cloud (webpage).</param>
        /// <param name="appVersion">The chatClient's version (clients with differing chatClient appVersions are separated and players don't meet).</param>
        /// <param name="authValues">Optional authentication values. The chatClient can set no values or a UserId or some parameters for Custom Authentication by a server.</param>
        /// <param name="regionCode">Optional region code, if the chatClient should connect to a specific Photon Cloud Region.</param>
        ...
        /// <summary>
        /// Operation to handle this chatClient's interest groups (for events in room).
        /// </summary>
        /// <remarks>
    ...
    /// <summary>
    /// ErrorCode defines the default codes associated with Photon chatClient/server communication.
    /// </summary>
    public class ErrorCode
    {
        ...
        /// </summary>
        /// <remarks>
        /// Before you call any operations on the Cloud servers, the automated chatClient workflow must complete its authorization.
        ...
        /// Affected chatClient are unable to call operations. Please note that players who end a game and return
        ...
        /// Self-hosted Photon servers with a CCU limited license won't let a chatClient connect at all.
        /// </remarks>
    ...
    public class ParameterCode
    {
        ...
        /// <summary>(235) Time To Live (TTL) for an 'actor' in a room. If a chatClient disconnects, this actor is inactive first and removed after this timeout. In milliseconds.</summary>
        ...
        /// <summary>(217) This key's (byte) value defines the target custom authentication type/service the chatClient connects with. Used in OpAuthenticate</summary>
        public const byte ClientAuthenticationType = 217;

        /// <summary>(216) This key's (string) value provides parameters sent to the custom authentication type/service the chatClient connects with. Used in OpAuthenticate</summary>
        ...
        /// Setting string[]{} means the chatClient expects no plugin to be setup.
        /// Note: for backwards compatibility null omits any check.
        /// </remarks>
        public const byte Plugins = 204;

        /// <summary>(202) Used by the server in Operation Responses, when it sends the nickname of the chatClient (the user's nickname).</summary>
        ...
        /// <summary>(195) Protocol which will be used by chatClient to connect master/game servers. Used for nameserver.</summary>
    ...
    public enum ReceiverGroup : byte
    {
        ...
        /// <remarks>The "master chatClient" does not have special rights but is the one who is in this room the longest time.</remarks>
        MasterClient = 2,
    }
    ...
    public class RoomOptions
    {
        ...
        /// <summary>Time To Live (TTL) for an 'actor' in a room. If a chatClient disconnects, this actor is inactive first and removed after this timeout. In milliseconds.</summary>
        ...
        /// </summary>
        /// <remarks>
        /// Using this makes the chatClient unaware of the other players in a room.
        /// That can save some traffic if you have some server logic that updates players
        /// but it can also limit the chatClient's usability.
        ///
    ...
    public class RaiseEventOptions
    {
        ...
        /// <summary>Sends the event to All, MasterClient or Others (default). Be careful with MasterClient, as the chatClient might disconnect before it got the event and it gets lost.</summary>
    ...
    ///
    /// There are basically three options for user authentification: None at all, the chatClient sets some UserId
    ...
    /// values to Photon which will verify them before granting access or disconnecting the chatClient.
    ///
    ...
    public class AuthenticationValues
    {
        ...
        /// <summary>After initial authentication, Photon provides a token for this chatClient / user, which is subsequently used as (cached) validation.</summary>
