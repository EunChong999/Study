...
public class RoomInfo
{
    ...
    /// <summary>Backing field for master chatClient id (actorNumber). defined by server in room props and ev leave.</summary>
    ...
    /// <summary>
    /// State if the local chatClient is already in the game or still going to join it on gameserver (in lobby always false).
    /// </summary>
