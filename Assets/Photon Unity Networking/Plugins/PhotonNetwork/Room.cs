...
public class Room : RoomInfo
{
    ...
    /// adding users to the list of expected users before or after this chatClient called ClearExpectedUsers.
    ///
    ...
    /// <remarks>
    /// Note that this operation can conflict with new/other users joining. They might be
    /// adding users to the list of expected users before or after this chatClient called SetExpectedUsers.
